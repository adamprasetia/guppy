<div class="box box-default">
    ...
    <div class="box-header with-border">
        <div class="pull-left">
            <h4><strong>DATA PENJUALAN</strong></h4>
        </div>
    </div>
    <?php endif ?>
    <div class="box-header with-border">
        <?php if(empty($this->input->get('popup'))): ?>
            <a href="<?php echo base_url('sell/add') ?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Tambah Penjualan</a>
        <?php endif ?>
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if(!empty($this->input->get('popup'))): ?>
                                <button class="btn btn-primary btn-choose-sell" type="button" name="button" data-id="<?php echo $value->id ?>"><i class="fa fa-use"></i> Pilih</button>
                                <div style="display:none" id="data-<?php echo $value->id ?>"><?php echo json_encode($value) ?></div>
                            <?php else: ?>                            
                                <a class="btn btn-default" href="<?php echo base_url('sell/edit/'.$value->id); ?>"><i class="fa fa-edit"></i></a>
                                <button class="btn btn-default" type="button" name="button" data-url="<?php echo base_url('sell/delete/'.$value->id); ?>" onclick="return deleteData(this)"><i class="fa fa-trash"></i></button>
                            <?php endif ?>
                        </td>
                    </tr>
                      <?php $no++; } ?>
